...
export const lessons: Lesson[] = [
  ...
  // Grade 10
  {
    ...
    title: 'الشعر الجاهلي',
    grade: 'الصف العاشر',
    unit: 'الوحدة الأولى: الشعر القديم',
  ...
  // Tawjihi
   {
    ...
    grade: 'التوجيهي',
    unit: 'الوحدة الثالثة: الأدب الحديث',
  ...
  },
  {
    ...
    title: 'الاستثناء',
    grade: 'التوجيهي',
    unit: 'الوحدة الخامسة: النحو المتقدم',
